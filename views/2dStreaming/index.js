...
import {View,Text, ScrollView,SafeAreaView, StyleSheet,AppState,    Animated,     PermissionsAndroid,    TouchableOpacity,Image,BackHandler,Platform, TouchableWithoutFeedback} from 'react-native'
...
export default class App extends Component<Props> {
            ...
            () => {
                ...
                this.getToken()
                    .then(async (token) => {
                        ...
                        mySession
                            .connect(token, JSON.stringify({ clientData: a?.id,username : a?.username ,group_id : a?.group?.id,type : 'flat'}))
                            .then(() => {
    ...
    {!this.state.loader ? 
      ...
      {/* <LinearGradient colors={['#000','transparent']} style={{height : hp(20), width : '100%',position : 'absolute'}} /> */}
