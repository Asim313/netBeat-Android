...
import {View,Text, ScrollView,SafeAreaView, StyleSheet, TouchableOpacity,Image,Dimensions, Platform} from 'react-native'
    ...
    <View style={{height : hp(6), justifyContent : 'center', alignItems : 'center'}}>
                  <TouchableOpacity onPress={async ()=>{
                    if(this.state.iosVr){
                     ...
                     await this.props.navigation.navigate(this.state.selected,{data : 'not_vr',list : this.state.streamingList})
                     setTimeout(() => {
                     this.setState({
                      page : 0 , selected : ''
                     })
