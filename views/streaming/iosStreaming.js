                        ...
                        mySession
                            ...
                            .then(() => {
                                ...
                                // }else{
                                    ...
                                    mySession.publish(publisher);
                                    mySession.on('signal:action', (event) => {
                                        this.setState({
                                            loaderState : true
                                        })
                                        setTimeout(()=>{
        ...
        <View  style={{flex : 1}}>
          ...
          />
            ...
            <View style={{height : '100%',justifyContent : 'flex-start',position : 'absolute',  marginLeft : wp(5)}}>
                <View style={{flex : 1}}>
                <Animated.View  style={{height : wp(12) , top : this.state.topHeaderHeight,width : '7%', backgroundColor : '#000', position : 'absolute'}} />
            <Animated.View style={{height : wp(12),top : this.state.topHeaderHeight, width : '100%'}}>
                <TouchableOpacity onPress={()=>{this.leaveSession()}}  style={{flex : 1, justifyContent : 'center', alignItems : 'flex-start'}}>
