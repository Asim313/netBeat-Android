...
export default class Details extends Component{
    ...
    // componentDidMount(){
    //     alert('data:', this.props.route?.params?.data)
    // }
  
  
    render(){
        //console.warn('data:', this.props.route?.params?.data?.concert_streams)
        return(
            <View style={{flex : 1, backgroundColor : 'white'}}>
                ...
                <Image style={{height : '100%', width : '100%'}}  resizeMode='stretch' source={{uri : baseDomain+this.props.route.params.data.Cover[0]?.url}}></Image>
