...
import { baseDomain } from '../../apis/axios';
                        ...
                        <ScrollView>
                            {this.state.response.map((i,index) => {
                                return <TouchableOpacity onPress={()=>{
                                    //alert(i)
                                     this.props.navigation.navigate('homeDetails',{data : i})
                                    }}  style={{flex : 1, height : index == 0 ? hp(37) : hp(20),width : '90%', alignSelf : 'center',justifyContent : 'center', alignItems : 'center', borderRadius : wp(5), marginBottom : hp(2.5)}}>
                                        <Image style={{height : '100%', width : '100%', borderRadius : wp(2)}}  resizeMode='cover' source={{uri : baseDomain+i.Cover[0]?.url}}></Image>
                                        {index == 0 ?
                                            ...
                                            <View style={{height : hp(7),backgroundColor : '#313030',width : '100%', marginHorizontal : wp(5),paddingHorizontal : wp(3), alignItems : 'flex-start', borderBottomLeftRadius : wp(2),borderBottomRightRadius : wp(2), justifyContent : 'center'}}>
                                                <Text style={{color : '#fff', fontSize : Size(2.1)}}>
                                                    {i.ArtistName}
                                                                                         ...
                                                                                         <View style={{height : hp(7),backgroundColor : '#313030',width : '100%',alignSelf : 'center', marginHorizontal : wp(5),paddingHorizontal : wp(3), alignItems : 'flex-start', borderBottomLeftRadius : wp(3),borderBottomRightRadius : wp(3), justifyContent : 'center'}}>
                                                                                             <Text style={{color : '#fff', fontSize : Size(2.1)}}>
                                                                                                 {i.ArtistName}
                                                                                             </Text>
                                                                                         </View>
