...
export default class SwiperComponent extends Component {
    ...
    async checkAndroidPermissions() {
      try {
          const audio = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.RECORD_AUDIO, {
              ...
              message: 'Vexuna needs access to your microphone',
  ...
  render() {
    return (
        ...
        <ScrollView>
        <View style={{height : hp(100),top : Platform.OS=='ios' ? IOS : 0, backgroundColor : '#fff'}}>
        <View style={{flex : 1}}>
    <View style={{flex : .97}}>
