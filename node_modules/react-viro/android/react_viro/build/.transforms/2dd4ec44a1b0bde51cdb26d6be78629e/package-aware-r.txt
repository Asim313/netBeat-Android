...
dimen alignment_marker_height
dimen alignment_marker_thickness
...
dimen transition_bottom_bar_height
...
drawable quantum_ic_close_white_24
drawable quantum_ic_settings_white_24
drawable redbox_top_border_background
drawable rippleable
drawable tooltip_frame_dark
drawable tooltip_frame_light
drawable transition
id __arcore_cancelButton
id __arcore_continueButton
id __arcore_messageText
...
id top
id topPanel
id transition_bottom_frame
id transition_frame
id transition_icon
id transition_question_text
id transition_switch_action
id transition_text
id transition_top_frame
id ui_alignment_marker
id ui_back_button
id ui_back_button_holder
id ui_settings_button
id ui_settings_button_holder
id uniform
id up
...
layout transition_view
layout ui_layer
layout ui_layer_with_portrait_support
mipmap ic_launcher
raw keep
string __arcore_cancel
string __arcore_continue
string __arcore_install_app
string __arcore_install_feature
string __arcore_installing
...
string app_name
string back_button_content_description
...
string dialog_button_got_it
string dialog_button_open_help_center
string dialog_message_incompatible_phone
string dialog_message_no_cardboard
string dialog_title
string dialog_title_incompatible_phone
string dialog_title_vr_core_not_enabled
string dialog_title_vr_core_not_installed
string dialog_title_warning
string dialog_vr_core_not_enabled
string dialog_vr_core_not_installed
...
string exo_controls_shuffle_description
string exo_controls_stop_description
string go_to_playstore_button
string go_to_vr_listeners_settings_button
string gvr_vr_mode_component
string header_description
string image_button_description
string image_description
string link_description
string no_browser_text
string place_your_phone_into_cardboard
string place_your_viewer_into_viewer_format
string search_description
string search_menu_title
string settings_button_content_description
string setup_button
string status_bar_notification_info_overflow
string switch_viewer_action
string switch_viewer_prompt
...
style ExoMediaButton_Shuffle
style GvrDialogTheme
style NoSystemUI
...
styleable DefaultTimeBar ad_marker_color ad_marker_width bar_height buffered_color played_ad_marker_color played_color scrubber_color scrubber_disabled_size scrubber_dragged_size scrubber_drawable scrubber_enabled_size touch_target_height unplayed_color
...
styleable PlayerControlView controller_layout_id fastforward_increment repeat_toggle_modes rewind_increment show_shuffle_button show_timeout
styleable PlayerView auto_show controller_layout_id default_artwork fastforward_increment hide_during_ads hide_on_touch player_layout_id repeat_toggle_modes resize_mode rewind_increment show_shuffle_button show_timeout shutter_background_color surface_type use_artwork use_controller
